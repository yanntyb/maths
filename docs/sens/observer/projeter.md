...
> [Retour au sens Observer](README.md)
...
|-------|------|---------|----------------------|
| 0 | [Mouvement sphere](../deplacer/) | `R^3 x (Omega x R) -> (Omega x R)` | deplace la sphere, produit `S` et `d` |
| 1 | [Produit de dualite](README.md) | `E* x E -> R` | intensite locale en `x` |
...
| 5 | [Produit lineaire](../ponderer/) | `R x R -> R` | attenuation par la distance |
...
Le [ponderer](../ponderer/) est le bloc qui connecte la geometrie (`integrale`) a l'optique (`1/d^2`). Via [currying](../ponderer/#currying-du-produit-lineaire), fixer `1/d^2` produit un attenuateur `(1/d^2) * _` qui pondere n'importe quelle aire.
